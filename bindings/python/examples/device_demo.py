...
BINDINGS = [
    ("/MACHINE/STATUS", nclink.Operation.GET_VALUE, "getValue"),
    ("/MACHINE/STATUS", nclink.Operation.SET_VALUE, "setValue"),
    ("/MACHINE/PART_COUNT", nclink.Operation.GET_VALUE, "getCount"),
    ("/MACHINE/CONTROLLER/WARNING", nclink.Operation.GET_VALUE, "getWarning"),
    ("/MACHINE/CONTROLLER/PROGRAM", nclink.Operation.GET_VALUE, "getProgram"),
    ("/MACHINE/CONTROLLER/TOOL_NUMBER", nclink.Operation.GET_VALUE, "getToolNumber"),
    ("/MACHINE/FEED_OVERRIDE", nclink.Operation.GET_VALUE, "getFeedOverride"),
    ("/MACHINE/MACHINING_MODE", nclink.Operation.GET_VALUE, "getMachiningMode"),
    ("/MACHINE/AXIS@S/SPEED", nclink.Operation.GET_VALUE, "getSpeedS"),
    ("/MACHINE/AXIS@X/POWER@1", nclink.Operation.GET_VALUE, "getPowerX"),
    ("/MACHINE/AXIS@Y/POWER@1", nclink.Operation.GET_VALUE, "getPowerY"),
    ("/MACHINE/AXIS@Z/POWER@1", nclink.Operation.GET_VALUE, "getPowerZ"),
    ("/MACHINE/AXIS@C/POWER@1", nclink.Operation.GET_VALUE, "getPowerC"),
    ("/MACHINE/AXIS@S/POWER@1", nclink.Operation.GET_VALUE, "getPowerS"),
    ("/MACHINE/AXIS@X/ACCELERATION@X", nclink.Operation.GET_VALUE, "getAccelerationXX"),
    ("/MACHINE/AXIS@X/ACCELERATION@Y", nclink.Operation.GET_VALUE, "getAccelerationXY"),
    ("/MACHINE/AXIS@X/ACCELERATION@Z", nclink.Operation.GET_VALUE, "getAccelerationXZ"),
    ("/MACHINE/AXIS@Y/ACCELERATION@X", nclink.Operation.GET_VALUE, "getAccelerationYX"),
    ("/MACHINE/AXIS@Y/ACCELERATION@Y", nclink.Operation.GET_VALUE, "getAccelerationYY"),
    ("/MACHINE/AXIS@Y/ACCELERATION@Z", nclink.Operation.GET_VALUE, "getAccelerationYZ"),
    ("/MACHINE/AXIS@Z/ACCELERATION@X", nclink.Operation.GET_VALUE, "getAccelerationZX"),
    ("/MACHINE/AXIS@Z/ACCELERATION@Y", nclink.Operation.GET_VALUE, "getAccelerationZY"),
    ("/MACHINE/AXIS@Z/ACCELERATION@Z", nclink.Operation.GET_VALUE, "getAccelerationZZ"),
    ("/MACHINE/AXIS@C/ACCELERATION@X", nclink.Operation.GET_VALUE, "getAccelerationCX"),
    ("/MACHINE/AXIS@C/ACCELERATION@Y", nclink.Operation.GET_VALUE, "getAccelerationCY"),
    ("/MACHINE/AXIS@C/ACCELERATION@Z", nclink.Operation.GET_VALUE, "getAccelerationCZ"),
    ("/MACHINE/AXIS@S/ACCELERATION@X", nclink.Operation.GET_VALUE, "getAccelerationSX"),
    ("/MACHINE/AXIS@S/ACCELERATION@Y", nclink.Operation.GET_VALUE, "getAccelerationSY"),
    ("/MACHINE/AXIS@S/ACCELERATION@Z", nclink.Operation.GET_VALUE, "getAccelerationSZ"),
]
