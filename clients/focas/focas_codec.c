...
static const ncl_focas_item kItems[] = {
     ...
     */
    /*
     * 写参数（`cnc_wrparam` 的**第二条帧**）= **0x8e**，载荷 **264 字节**：
     * `[@0..16 = 0][@16 = 0x108 = 264][@20 = 参数号][@24 = type（BE16，机床属性表给的）]`
     * `[@28 = 值（BE32）]` + 补 0（2026-09-23 抓帧，01 册 §11.25）。
     * 第一条是 `WRPARAM`（0xa0）问属性 —— 两条都要，少一条机床不收。
     */
