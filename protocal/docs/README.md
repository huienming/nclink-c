...
| 07 | [海德汉 HEIDENHAIN（LSV2）](07-HEIDENHAIN-LSV2.md) | 19000 | TCP | 🟢 45命令 + **设备侧握手/9 数据项/5 文件端点闭环**（§2.1/§2.2） | pyLSV2 |
...
| 32 | [**标准第 4 部分：数据项定义**](32-标准第4部分-数据项定义.md) | — | — | 🔵 标准原文 | 设备/组件/数据对象的**数据项字典**（表 1-9）+ 与本仓库实现的对照：点位名只能用这里的 Type |
